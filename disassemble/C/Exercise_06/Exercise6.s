...
# options passed:  -imultilib 32 -imultiarch i386-linux-gnu Exercise6.c
# -m32 -masm=intel -mtune=generic -march=i686 -auxbase-strip Exercise6.s -g
...
# Exercise6.c:6: 	int addition = h + k;
	.loc 1 6 0
	mov	edx, DWORD PTR 8[ebp]	# tmp94, h
	mov	eax, DWORD PTR 12[ebp]	# tmp95, k
	add	eax, edx	# tmp93, tmp94
	mov	DWORD PTR -4[ebp], eax	# addition, tmp93
# Exercise6.c:7:     return addition;
	.loc 1 7 0
	mov	eax, DWORD PTR -4[ebp]	# _4, addition
# Exercise6.c:8: }
	.loc 1 8 0
	leave
	.cfi_restore 5
...
# Exercise6.c:13: 	int a1 = 6;
	.loc 1 13 0
	mov	DWORD PTR -20[ebp], 6	# a1,
# Exercise6.c:14:     int a2 = 9;
	.loc 1 14 0
	mov	DWORD PTR -16[ebp], 9	# a2,
# Exercise6.c:15:     int result = addition(a1, a2);
	.loc 1 15 0
	push	DWORD PTR -16[ebp]	# a2
	push	DWORD PTR -20[ebp]	# a1
	call	addition	#
	add	esp, 8	#,
	mov	DWORD PTR -12[ebp], eax	# result, tmp90
# Exercise6.c:17:     printf("Added values is: %d\n", result);
	.loc 1 17 0
	sub	esp, 8	#,
	push	DWORD PTR -12[ebp]	# result
	lea	eax, .LC0@GOTOFF[ebx]	# tmp91,
	push	eax	# tmp91
	call	printf@PLT	#
	add	esp, 16	#,
# Exercise6.c:19: 	return EXIT_SUCCESS;
	.loc 1 19 0
	mov	eax, 0	# _7,
# Exercise6.c:20: }
	.loc 1 20 0
...
.LASF61:
	.string	"/home/jdg/git/reverse_engineering/disassemble/C/Exercise_06"
.LASF34:
	.string	"_lock"
.LASF29:
	.string	"_flags2"
