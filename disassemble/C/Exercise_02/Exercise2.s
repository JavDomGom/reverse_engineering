...
# options passed:  -imultilib 32 -imultiarch i386-linux-gnu Exercise2.c
# -m32 -masm=intel -mtune=generic -march=i686 -auxbase-strip Exercise2.s -g
...
# Exercise2.c:6: 	int i=0;
	.loc 1 6 0
	mov	DWORD PTR -12[ebp], 0	# i,
# Exercise2.c:8: 	for (i = 1;i < 15;i++)
	.loc 1 8 0
	mov	DWORD PTR -12[ebp], 1	# i,
	jmp	.L2	#
.L3:
# Exercise2.c:10: 		printf ("Value of i per round %d \n", i);
	.loc 1 10 0 discriminator 3
	sub	esp, 8	#,
	push	DWORD PTR -12[ebp]	# i
	lea	eax, .LC0@GOTOFF[ebx]	# tmp90,
	push	eax	# tmp90
	call	printf@PLT	#
	add	esp, 16	#,
# Exercise2.c:8: 	for (i = 1;i < 15;i++)
...
# Exercise2.c:8: 	for (i = 1;i < 15;i++)
	...
	cmp	DWORD PTR -12[ebp], 14	# i,
	jle	.L3	#,
# Exercise2.c:13: 	return EXIT_SUCCESS;
...
.LASF60:
	.string	"/home/jdg/git/reverse_engineering/disassemble/C/Exercise_02"
.LASF23:
