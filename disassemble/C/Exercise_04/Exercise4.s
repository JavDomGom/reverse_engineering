...
# options passed:  -imultilib 32 -imultiarch i386-linux-gnu Exercise4.c
# -m32 -masm=intel -mtune=generic -march=i686 -auxbase-strip Exercise4.s -g
...
# Exercise4.c:4:     int counter1 = 7;
	.loc 1 4 0
	mov	DWORD PTR -12[ebp], 7	# counter1,
# Exercise4.c:5:     int counter2 = 20;
	.loc 1 5 0
	mov	DWORD PTR -8[ebp], 20	# counter2,
# Exercise4.c:6:     int result = counter1 + counter2;
	.loc 1 6 0
	mov	edx, DWORD PTR -12[ebp]	# tmp94, counter1
	mov	eax, DWORD PTR -8[ebp]	# tmp95, counter2
	add	eax, edx	# tmp93, tmp94
	mov	DWORD PTR -4[ebp], eax	# result, tmp93
# Exercise4.c:8:     return result;
	.loc 1 8 0
	mov	eax, DWORD PTR -4[ebp]	# _4, result
# Exercise4.c:9: }
	.loc 1 9 0
	leave
	.cfi_restore 5
...
.LASF11:
	.string	"long int"
.LASF63:
	.string	"/home/jdg/git/reverse_engineering/disassemble/C/Exercise_04"
.LASF31:
	.string	"_cur_column"
.LASF50:
