...
# options passed:  -imultilib 32 -imultiarch i386-linux-gnu Exercise8.c
# -m32 -masm=intel -mtune=generic -march=i686 -auxbase-strip Exercise8.s -g
...
# Exercise8.c:5:     printf ("%d\n", x);
	.loc 1 5 0
	sub	esp, 8	#,
	push	DWORD PTR 8[ebp]	# x
	lea	edx, .LC0@GOTOFF[eax]	# tmp88,
	push	edx	# tmp88
	mov	ebx, eax	#, tmp87
	call	printf@PLT	#
	add	esp, 16	#,
...
# Exercise8.c:12:     a = 7;
	.loc 1 12 0
	mov	DWORD PTR -12[ebp], 7	# a,
# Exercise8.c:13:     b = 0;
	.loc 1 13 0
	mov	DWORD PTR -16[ebp], 0	# b,
# Exercise8.c:14:     b = 1;
	.loc 1 14 0
	mov	DWORD PTR -16[ebp], 1	# b,
# Exercise8.c:16:     while (b <= 14)
	.loc 1 16 0
	jmp	.L3	#
.L4:
# Exercise8.c:18:         printFunction (b);
	.loc 1 18 0
	sub	esp, 12	#,
	push	DWORD PTR -16[ebp]	# b
	call	printFunction	#
	add	esp, 16	#,
# Exercise8.c:19:         b++;
	.loc 1 19 0
	add	DWORD PTR -16[ebp], 1	# b,
.L3:
# Exercise8.c:16:     while (b <= 14)
	.loc 1 16 0
	cmp	DWORD PTR -16[ebp], 14	# b,
	jle	.L4	#,
# Exercise8.c:21: }
	.loc 1 21 0
	nop
...
.LASF60:
	.string	"/home/jdg/git/reverse_engineering/disassemble/C/Exercise_08"
.LASF62:
