...
# options passed:  -imultilib 32 -imultiarch i386-linux-gnu Exercise3.c
# -m32 -masm=intel -mtune=generic -march=i686 -auxbase-strip Exercise3.s -g
...
# Exercise3.c:6: 	int i = 0;
	.loc 1 6 0
	mov	DWORD PTR -12[ebp], 0	# i,
# Exercise3.c:8: 	while (i < 10){
	.loc 1 8 0
	jmp	.L2	#
.L3:
# Exercise3.c:9: 		printf ("Value of i per round %d\n", i);
	.loc 1 9 0
	sub	esp, 8	#,
...
# Exercise3.c:8: 	while (i < 10){
	.loc 1 8 0
	cmp	DWORD PTR -12[ebp], 9	# i,
	jle	.L3	#,
# Exercise3.c:13: 	return EXIT_SUCCESS;
	.loc 1 13 0
	mov	eax, 0	# _5,
# Exercise3.c:14: }
	.loc 1 14 0
...
.LASF60:
	.string	"/home/jdg/git/reverse_engineering/disassemble/C/Exercise_03"
.LASF34:
	.string	"_lock"
.LASF29:
	.string	"_flags2"
