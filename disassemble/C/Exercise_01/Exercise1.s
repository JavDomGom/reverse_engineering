...
# options passed:  -imultilib 32 -imultiarch i386-linux-gnu Exercise1.c
# -m32 -masm=intel -mtune=generic -march=i686 -auxbase-strip Exercise1.s -g
...
# Exercise1.c:6: 	int counter = 7;
	.loc 1 6 0
	mov	DWORD PTR -12[ebp], 7	# counter,
# Exercise1.c:8: 	if (counter == 10)
	.loc 1 8 0
	cmp	DWORD PTR -12[ebp], 10	# counter,
	jne	.L2	#,
# Exercise1.c:10: 		printf ("Counter is 10.\n");
	.loc 1 10 0
	sub	esp, 12	#,
	...
	jmp	.L3	#
.L2:
# Exercise1.c:14: 		printf ("Counter is not 10.\n");
	.loc 1 14 0
	sub	esp, 12	#,
	lea	edx, .LC1@GOTOFF[eax]	# tmp91,
	push	edx	# tmp91
	mov	ebx, eax	#, tmp87
	call	puts@PLT	#
	add	esp, 16	#,
.L3:
# Exercise1.c:17: 	return EXIT_SUCCESS;
	.loc 1 17 0
	mov	eax, 0	# _6,
# Exercise1.c:18: }
	.loc 1 18 0
...
.LASF60:
	.string	"/home/jdg/git/reverse_engineering/disassemble/C/Exercise_01"
.LASF23:
